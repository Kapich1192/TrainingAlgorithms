...
он мог бы обойтись двумя разрезами — сначала он разделил бы рулет на две половинки, а потом совместил бы две половинки
...
Замечание
Чтобы разрезать рулет на 6частей,
...
Ване понадобится разделить его в соотношении 2:32:3, после чего совместить два рулета по левому краю и разрезать
...
public class Task3 {
    ...
    public static int rasrez(int a){
        if(a%2==0) return a/2; else return a/2+1;
    }
}
